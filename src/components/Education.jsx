      ...
      <div className="flex flex-col lg:flex-row mt-4">
        ...
        <div className="lg:w-1/2 px-4">
          <div className="mb-4 border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
            ...
            >
              <li className="mr-1" role="presentation">
                <button
                  className={`inline-block py-2 px-3 border-b-2 rounded-t-lg transition duration-300 ${activeTab === "ssc"
              ...
              <li className="mr-1" role="presentation">
                <button
                  className={`inline-block py-2 px-3 border-b-2 rounded-t-lg transition duration-300 ${activeTab === "hsc"
              ...
              <li className="mr-1" role="presentation">
                <button
                  className={`inline-block py-2 px-3 border-b-2 rounded-t-lg transition duration-300 ${activeTab === "graduation"
              ...
              <li role="presentation">
                <button
                  className={`inline-block py-2 px-3 border-b-2 rounded-t-lg transition duration-300 ${activeTab === "certification"
          ...
          <div id="default-styled-tab-content ">
            <div
              className={`p-4 rounded-lg bg-gradient-to-r from-indigo-500 to-blue-400 edu-card  text-white font-serif animate-fadeInUp2 ${activeTab === "ssc" ? "" : "hidden"
                }`}
              id="ssc-content"
              role="tabpanel"
            ...
            >
              ...
              <p className="text-lg pt-6">
                <strong>School :</strong> Siddhi International Academy
              </p>
              <p className="text-lg">
                <strong>Percentage :</strong> 86.40 %
              </p>
              <p className="text-lg">
                <strong>Location:</strong> Taharabad-satana, Nashik,
                Maharashtra-423301.
              </p>
              <p className="text-lg">
                <strong>Complition Year :</strong> 2017
              </p>
              <p className="text-lg">
            ...
            <div
              className={`p-4 rounded-lg bg-gradient-to-r from-yellow-500 to-yellow-400 edu-card text-white font-serif animate-fadeInUp2 ${activeTab === "hsc" ? "" : "hidden"
                }`}
              id="hsc-content"
              role="tabpanel"
            ...
            >
              ...
              <p className="text-lg pt-6">
                <strong>Institution:</strong> Dr A.G Thakre College of Arts and Science,
                Nashik-Talwade.
              </p>
              <p className="text-lg">
              ...
              <p className="text-lg">
                <strong>Dates of Attendance:</strong> 2018 - 2019
              </p>
              <p className="text-lg">
                <strong>Group:</strong>PCM
              </p>
              <p className="text-lg">
            ...
            >
              ...
              <p className="text-lg">
                <strong>College:</strong> Hi-Tech Institute of Technology.
              </p>
              <p className="text-lg">
                <strong>CGPA:</strong> 7.2 (Out of 10)
              </p>
              <p className="text-lg">
                <strong>Location:</strong> Chh. Sambhajinagar, Maharashtra-431001
              </p>
              <p className="text-lg">
                <strong>Dates of Attendance:</strong> 2019 - 2023
              </p>
              <p className="text-lg">
            ...
            <div
              className={`p-4 rounded-lg bg-gradient-to-r from-green-600 to-green-400 edu-card text-white font-serif animate-fadeInUp2 ${activeTab === "certification" ? "" : "hidden"
                }`}
            ...
            >
              ...
              <ul className="list-disc pt-6 pl-5 text-lg">
                <li>
                  <a
                    href="https://drive.google.com/file/d/1deo8mBqS6uCIfoVDAlsnorl8K3R2_BD2/view?usp=sharing"
                ...
                <li>
                  <a
                    href="https://drive.google.com/file/d/1GhoO5H28psMYzaZMQCPCXHbQyhfoGwvN/view?usp=sharing"
                    className="text-white hover:text-cyan-300"
                  >
                     NPTEL- Introduction to Industry.
                  </a>
                </li>
        ...
        <div className="lg:w-1/2 flex justify-center items-center">
          ...
          <section
            ref={ref1}
            className={`filter-shadow ${isVisible1 ? "animate-fadeIn" : "opacity-0"
              }`}
          >
            <div class="main">
